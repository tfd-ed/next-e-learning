  ...
  <div class="bg-neutral-900">
    <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
      ...
      <div class="max-w-3xl mb-10 lg:mb-14">
        ...
        <p class="mt-1 text-neutral-400">With over 30 awards, and achievements, we proudly demonstrate
          our unwavering dedication to excellence and client success.</p>
      </div>
      <!-- End Title -->
            ...
            <footer class="mt-6">
              <div class="flex items-center">
                ...
                <div class="ms-4 md:ms-0">
                  ...
                  <div class="text-xs text-neutral-400">Director Payments & Risk | Airbnb
                  </div>
                </div>
              </div>
            </footer>
